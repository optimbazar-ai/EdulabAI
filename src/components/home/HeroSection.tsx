      ...
      <div className="container-custom relative z-10 pt-24 pb-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8">
            ...
            >
              Faqat sun'iy intellekt (AI) tomonidan o'qitiladigan, zamonaviy va online ta'lim platformasi.
              Farzandingiz bilan kelajak texnologiyalarini bugundan o'rganing.
            </p>
            ...
            >
              {[
                { icon: Users, value: "100%", label: "Online ta'lim" },
                { icon: Award, value: "AI", label: "Mentorlar" },
                { icon: Star, value: "99%", label: "AI yordamida o'sish" },
              ].map((stat, index) => (
            ...
            <div className="relative">
              ...
              <div className="bg-card/95 backdrop-blur-xl rounded-3xl p-8 shadow-elevated">
                <div className="space-y-6">
                  ...
                  {/* Course Preview */}
                  {[
                    { emoji: "🤖", name: "Prompt Engineering", students: "250" },
                    { emoji: "🎨", name: "AI Tasvirlar", students: "180" },
                    { emoji: "💻", name: "AI Dasturlash", students: "320" },
                  ].map((course, index) => (
                    <div
                      key={index}
